...
export const NavBar = () => {
    ...
    return (
        <>
            <nav className="flex items-center justify-between flex-wrap bg-purple-400 p-6">
                ...
                <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    ...
                    <div>
                        <button onClick={startLogout} className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Salir</button>
                    </div>
                </div>
            </nav>
        </>
